...
const legalPages: Record<LegalPageKey, LegalPageData> = {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'Telegram username или иные контактные данные, которые пользователь сам отправляет Кириллу;',
      ...
      },
      {
        ...
        items: [
          'ответить на обращение пользователя в Telegram;',
  ...
  'personal-data-consent': {
    ...
    intro:
      'Это согласие применяется, когда пользователь сам пишет Кириллу в Telegram по ссылке с сайта и сообщает данные для связи и обсуждения занятий.',
    sections: [
      {
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Информация на сайте не является публичной офертой. Условия занятий, стоимость, расписание и формат обсуждаются индивидуально после обращения в Telegram.',
          'Обращение в Telegram не является покупкой и не обязывает пользователя оплачивать занятия.',
        ],
      },
      {
